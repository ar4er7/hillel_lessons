...
"""тут начинаю добавлять 10 студентов для 1 задачи 14го занятия"""
...
gr.add_student(st9)
gr.add_student(st10)
print(gr.count) #на этом моменте группа заполнена максимально. Следующий студернт - вызовет ошибку
